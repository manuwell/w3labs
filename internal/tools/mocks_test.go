...
func (_mock *MockLogger) Debug(msg string, fields map[string]any) {
...
func (_c *MockLogger_Debug_Call) Run(run func(msg string, fields map[string]any)) *MockLogger_Debug_Call {
...
func (_c *MockLogger_Debug_Call) RunAndReturn(run func(msg string, fields map[string]any)) *MockLogger_Debug_Call {
	_c.Run(run)
	return _c
}

// Error provides a mock function for the type MockLogger
func (_mock *MockLogger) Error(msg string, fields map[string]any) {
	_mock.Called(msg, fields)
	return
}
...
func (_c *MockLogger_Error_Call) Run(run func(msg string, fields map[string]any)) *MockLogger_Error_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockLogger_Error_Call) RunAndReturn(run func(msg string, fields map[string]any)) *MockLogger_Error_Call {
	_c.Run(run)
	return _c
}

// Fatal provides a mock function for the type MockLogger
func (_mock *MockLogger) Fatal(msg string, fields map[string]any) {
	_mock.Called(msg, fields)
	return
}
...
func (_c *MockLogger_Fatal_Call) Run(run func(msg string, fields map[string]any)) *MockLogger_Fatal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockLogger_Fatal_Call) RunAndReturn(run func(msg string, fields map[string]any)) *MockLogger_Fatal_Call {
	_c.Run(run)
	return _c
}

// Info provides a mock function for the type MockLogger
func (_mock *MockLogger) Info(msg string, fields map[string]any) {
	_mock.Called(msg, fields)
	return
}
...
func (_c *MockLogger_Info_Call) Run(run func(msg string, fields map[string]any)) *MockLogger_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockLogger_Info_Call) RunAndReturn(run func(msg string, fields map[string]any)) *MockLogger_Info_Call {
	_c.Run(run)
	return _c
}

// Warn provides a mock function for the type MockLogger
func (_mock *MockLogger) Warn(msg string, fields map[string]any) {
	_mock.Called(msg, fields)
	return
}
...
func (_c *MockLogger_Warn_Call) Run(run func(msg string, fields map[string]any)) *MockLogger_Warn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockLogger_Warn_Call) RunAndReturn(run func(msg string, fields map[string]any)) *MockLogger_Warn_Call {
	_c.Run(run)
	return _c
}
